...
class AnduraDesignSystem {
  ...
  /// Creates an app-local design system by overriding a bundled system.
  AnduraDesignSystem copyWith({
    String? id,
    String? name,
    String? category,
    String? description,
    AnduraNativeBrightness? nativeBrightness,
    int? background,
    int? surface,
    int? surfaceWarm,
    int? foreground,
    int? foregroundSecondary,
    int? muted,
    int? border,
    int? accent,
    int? accentOn,
    ...
    nativeBrightness: nativeBrightness ?? this.nativeBrightness,
    ...
    motionBaseMs: motionBaseMs ?? this.motionBaseMs,
    containerMax: containerMax ?? this.containerMax,
    componentGroups: componentGroups ?? this.componentGroups,
    sourceClassCount: sourceClassCount ?? this.sourceClassCount,
  );
}
